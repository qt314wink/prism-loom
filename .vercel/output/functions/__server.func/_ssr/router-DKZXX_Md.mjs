...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DKZXX_Md.js
var router_DKZXX_Md_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-YTLtsnj-.css";
var APP_NAME = "Locus";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Interactive function grapher. Plot damped waves, tangents, beats, and the laws of light. Zoom, pan, and read values under the cursor."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-Sz0iPQxI.mjs");
...
//#endregion
export { getRouter, router_DKZXX_Md_exports as t };
